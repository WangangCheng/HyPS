...
with open("your_path/Datasets/EADC/test.txt", "r") as file:
...
for sub in subjects:
    # Paths
    input_path = f"your_path/Datasets/EADC/{sub}/{sub}_mask.nii.gz"
    input_file = f"your_path/output/submission/SwinUNETR2024-08-02/{sub}.nii"
    output_file = f"your_path/Datasets/EADC/{sub}/{sub}_pred.nii"
    ...
    post_output_file = f"your_path/Datasets/EADC/{sub}/{sub}_post.nii"
...
for sub in subjects:
    ...
    mask_path = f"your_path/Datasets/EADC/{sub}/{sub}_mask.nii.gz"
    pred_path = f"your_path/Datasets/EADC/{sub}/{sub}_post.nii"
